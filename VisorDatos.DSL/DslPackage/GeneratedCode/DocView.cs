...
namespace VisorDatosDSL
{
	...
	/// </summary>
	internal partial class VisorDatosDSLDocView : VisorDatosDSLDocViewBase
	{
		/// <summary>
		/// Constructs a new VisorDatosDSLDocView.
		/// </summary>
		public VisorDatosDSLDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class VisorDatosDSLDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new VisorDatosDSLDocView.
		/// </summary>
		protected VisorDatosDSLDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			VisorDatosDSLDocDataBase docData = this.DocData as VisorDatosDSLDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for VisorDatosDSLDocViewBase should be an VisorDatosDSLDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::VisorDatosDSL.VisorDatosDSLDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::VisorDatosDSL.VisorDatosDSLDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::VisorDatosDSL.VisorDatosDSLToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::VisorDatosDSL.VisorDatosDSLToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.VisorDatosDSLDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::VisorDatosDSL.VisorDatosDSLHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::VisorDatosDSL.VisorDatosDSLHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::VisorDatosDSL.VisorDatosDSLHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
