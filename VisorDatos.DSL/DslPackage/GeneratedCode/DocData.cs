...
namespace VisorDatosDSL
{
	...
	/// </summary>
	internal partial class VisorDatosDSLDocData : VisorDatosDSLDocDataBase
	{
		/// <summary>
		/// Constructs a new VisorDatosDSLDocData.
		/// </summary>
		public VisorDatosDSLDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a VisorDatosDSL document in memory.
	/// </summary>
	internal abstract partial class VisorDatosDSLDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new VisorDatosDSLDocDataBase.
		/// </summary>
		protected VisorDatosDSLDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::VisorDatosDSL.VisorDatosDSLDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::VisorDatosDSL.VisorDatosDSLDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::VisorDatosDSL.VisorDatosDSLDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::VisorDatosDSL.VisorDatosDSLDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::VisorDatosDSL.FuentesDeDatosModel modelRoot = null;
			...
			global::VisorDatosDSL.VisorDatosDSLDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::VisorDatosDSL.VisorDatosDSLSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::VisorDatosDSL.VisorDatosDSLDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::VisorDatosDSL.VisorDatosDSLDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::VisorDatosDSL.FuentesDeDatosModel modelRoot = (global::VisorDatosDSL.FuentesDeDatosModel)this.RootElement;
			...
			{
				global::VisorDatosDSL.VisorDatosDSLDiagram diagram = diagrams[0] as global::VisorDatosDSL.VisorDatosDSLDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::VisorDatosDSL.VisorDatosDSLSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::VisorDatosDSL.VisorDatosDSLSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::VisorDatosDSL.VisorDatosDSLDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::VisorDatosDSL.VisorDatosDSLSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::VisorDatosDSL.FuentesDeDatosModel modelRoot = this.RootElement as global::VisorDatosDSL.FuentesDeDatosModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::VisorDatosDSL.VisorDatosDSLSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
