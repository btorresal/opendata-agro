...
namespace VisorDatosDSL
{
	...
	partial class VisorDatosDSLDomainModel
	{
		///<Summary>
		...
		partial void InitializeSerialization(DslModeling::Store store)
		{
			...
			VisorDatosDSLSerializationHelper.Instance.InitializeSerialization(store);	
		}
	}
	
	
	/// <summary>
	/// Helper class for serializing and deserializing VisorDatosDSL models.
	/// </summary>
	public abstract partial class VisorDatosDSLSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		protected VisorDatosDSLSerializationHelperBase() { }
		#endregion
		...
		internal protected virtual void InitializeSerialization(DslModeling::Store store)
		{
			...
			DslModeling::IMonikerResolver monikerResolver = store.FindMonikerResolver(VisorDatosDSLDomainModel.DomainModelId);
			if (monikerResolver == null)
			{
				monikerResolver = new VisorDatosDSLSerializationBehaviorMonikerResolver(store, directory);
				store.AddMonikerResolver(VisorDatosDSLDomainModel.DomainModelId, monikerResolver);
			}
			
			// Add serialization behaviors
			directory.AddBehavior(VisorDatosDSLSerializationBehavior.Instance);
		}
	...
	/// Helper class for serializing and deserializing VisorDatosDSL models.
	/// </summary>
	public sealed partial class VisorDatosDSLSerializationHelper : VisorDatosDSLSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Private constructor to prevent direct instantiation.
		/// </summary>
		private VisorDatosDSLSerializationHelper() : base () { }
		#endregion
		...
		/// Singleton instance.
		/// </summary>
		private static VisorDatosDSLSerializationHelper instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static VisorDatosDSLSerializationHelper Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (VisorDatosDSLSerializationHelper.instance == null)
					VisorDatosDSLSerializationHelper.instance = new VisorDatosDSLSerializationHelper();
				return VisorDatosDSLSerializationHelper.instance;
			}
		}
		#endregion
	}
...
namespace VisorDatosDSL
{
	...
	partial class VisorDatosDSLSerializationHelperBase
	{
	
		/// <summary>
		/// Loads a FuentesDeDatosModel instance into the default partition of the given store, and ignore serialization result.
		/// </summary>
		/// <param name="store">The new FuentesDeDatosModel instance will be created into the default partition of this store.</param>
		/// <param name="fileName">Name of the file from which the FuentesDeDatosModel instance will be deserialized.</param>
		...
		/// </param>
		/// <returns>The loaded FuentesDeDatosModel instance.</returns>
		public virtual FuentesDeDatosModel LoadModel(DslModeling::Store store, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			#region Check Parameters
			if (store == null) 
				throw new global::System.ArgumentNullException("store");
		...
		/// <summary>
		/// Loads a FuentesDeDatosModel instance into the default partition of the given store.
		/// </summary>
		...
		/// </param>
		/// <returns>The loaded FuentesDeDatosModel instance.</returns>
		public virtual FuentesDeDatosModel LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Store store, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			#region Check Parameters
			if (store == null) 
				throw new global::System.ArgumentNullException("store");
		...
		/// <summary>
		/// Loads a FuentesDeDatosModel instance.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the load operation.</param>
		/// <param name="partition">Partition in which the new FuentesDeDatosModel instance will be created.</param>
		/// <param name="fileName">Name of the file from which the FuentesDeDatosModel instance will be deserialized.</param>
		/// <param name="schemaResolver">
		/// An ISchemaResolver that allows the serializer to do schema validation on the root element (and everything inside it).
		/// If null is passed, schema validation will not be performed.
		...
		public virtual FuentesDeDatosModel LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Partition partition, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			#region Check Parameters
			...
			{
				throw new global::System.InvalidOperationException(VisorDatosDSLDomainModel.SingletonResourceManager.GetString("MissingTransaction"));
			}
			
			FuentesDeDatosModel modelRoot = null;
			DslModeling::DomainXmlSerializerDirectory directory = this.GetDirectory(partition.Store);
			DslModeling::DomainClassXmlSerializer modelRootSerializer = directory.GetSerializer(FuentesDeDatosModel.DomainClassId);
			global::System.Diagnostics.Debug.Assert(modelRootSerializer != null, "Cannot find serializer for FuentesDeDatosModel!");
				...
				using (global::System.IO.FileStream fileStream = global::System.IO.File.OpenRead(fileName))
				{
					...
					using (DslModeling::Transaction t = partition.Store.TransactionManager.BeginTransaction("Load Model from " + fileName, true, transactionContext))
					{
						...
						if (fileStream.Length > 5)
						{
							try
							{
								global::System.Xml.XmlReaderSettings settings = VisorDatosDSLSerializationHelper.Instance.CreateXmlReaderSettings(serializationContext, false);
								using (global::System.Xml.XmlReader reader = global::System.Xml.XmlReader.Create(fileStream, settings))
								{
									...
									modelRoot = modelRootSerializer.TryCreateInstance(serializationContext, reader, partition) as FuentesDeDatosModel;
		...
		/// <param name="modelRoot">FuentesDeDatosModel instance to be saved.</param>
		/// <param name="fileName">Name of the file in which the FuentesDeDatosModel instance will be saved.</param>
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, FuentesDeDatosModel modelRoot, string fileName)
		{
		...
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, FuentesDeDatosModel modelRoot, string fileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <param name="modelRoot">FuentesDeDatosModel instance to be saved.</param>
		/// <param name="fileName">Name of the file in which the FuentesDeDatosModel instance will be saved.</param>
		/// <param name="encoding">Encoding to use when saving the FuentesDeDatosModel instance.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, FuentesDeDatosModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		/// <param name="encoding">Encoding to use when saving the FuentesDeDatosModel instance.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		/// <returns>In-memory stream containing the serialized FuentesDeDatosModel instance.</returns>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		internal global::System.IO.MemoryStream InternalSaveModel(DslModeling::SerializationResult serializationResult, FuentesDeDatosModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			...
			global::System.Xml.XmlWriterSettings settings = VisorDatosDSLSerializationHelper.Instance.CreateXmlWriterSettings(serializationContext, false, encoding);
		...
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="diagram">VisorDatosDSLDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="encoding">Encoding to use when saving the diagram.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		/// <returns>In-memory stream containing the serialized VisorDatosDSLDiagram instance.</returns>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		internal global::System.IO.MemoryStream InternalSaveDiagram(DslModeling::SerializationResult serializationResult, VisorDatosDSLDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert(serializationResult != null);
			...
			// MonikerResolver shouldn't be required in Save operation, so not calling SetupMonikerResolver() here.
			serializationContext.WriteOptionalPropertiesWithDefaultValue = writeOptionalPropertiesWithDefaultValue;
			global::System.Xml.XmlWriterSettings settings = VisorDatosDSLSerializationHelper.Instance.CreateXmlWriterSettings(serializationContext, true, encoding);
			using (global::System.Xml.XmlWriter writer = global::System.Xml.XmlWriter.Create(newFileContent, settings))
			{
		...
		/// <summary>
		/// Helper method to create and initialize a new FuentesDeDatosModel.
		/// </summary>
		internal protected virtual FuentesDeDatosModel CreateModelHelper(DslModeling::Partition modelPartition)
		{
			FuentesDeDatosModel model = new FuentesDeDatosModel(modelPartition);
			return model;
		}
		
		/// <summary>
		/// Loads a FuentesDeDatosModel instance and its associated diagram file into the default partition of the given store, and ignore serialization result.
		/// </summary>
		/// <param name="store">The new FuentesDeDatosModel instance will be created into the default partition of this store.</param>
		/// <param name="modelFileName">Name of the file from which the FuentesDeDatosModel instance will be deserialized.</param>
		/// <param name="diagramFileName">Name of the file from which the VisorDatosDSLDiagram instance will be deserialized.</param>
		/// <param name="schemaResolver">
		/// An ISchemaResolver that allows the serializer to do schema validation on the root element (and everything inside it).
		/// If null is passed, schema validation will not be performed.
		/// </param>
		...
		/// </param>
		/// <returns>The loaded FuentesDeDatosModel instance.</returns>
		public virtual FuentesDeDatosModel LoadModelAndDiagram(DslModeling::Store store, string modelFileName, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
		...
		/// <summary>
		/// Loads a FuentesDeDatosModel instance and its associated diagram file into the default partition of the given store.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the load operation.</param>
		/// <param name="store">The new FuentesDeDatosModel instance will be created into the default partition of this store.</param>
		/// <param name="modelFileName">Name of the file from which the FuentesDeDatosModel instance will be deserialized.</param>
		...
		/// <summary>
		/// Loads a FuentesDeDatosModel instance and its associated diagram file.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the load operation.</param>
		/// <param name="modelPartition">Partition in which the new FuentesDeDatosModel instance will be created.</param>
		/// <param name="modelFileName">Name of the file from which the FuentesDeDatosModel instance will be deserialized.</param>
		/// <param name="diagramPartition">Partition in which the new VisorDatosDSLDiagram instance will be created.</param>
		/// <param name="diagramFileName">Name of the file from which the VisorDatosDSLDiagram instance will be deserialized.</param>
		/// <param name="schemaResolver">
		/// An ISchemaResolver that allows the serializer to do schema validation on the root element (and everything inside it).
		/// If null is passed, schema validation will not be performed.
		...
		public virtual FuentesDeDatosModel LoadModelAndDiagram(DslModeling::SerializationResult serializationResult, DslModeling::Partition modelPartition, string modelFileName, DslModeling::Partition diagramPartition, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			...
			VisorDatosDSLDiagram diagram = null;
			DslModeling::DomainXmlSerializerDirectory directory = this.GetDirectory(diagramPartition.Store);
			DslModeling::DomainClassXmlSerializer diagramSerializer = directory.GetSerializer(VisorDatosDSLDiagram.DomainClassId);
			global::System.Diagnostics.Debug.Assert(diagramSerializer != null, "Cannot find serializer for VisorDatosDSLDiagram");
						...
						using (DslModeling::Transaction t = diagramPartition.Store.TransactionManager.BeginTransaction("LoadDiagram", true, transactionContext))
						{
							...
							if (fileStream.Length > 5)
							{
								...
								try
								{
									...
									{
										reader.MoveToContent();
										diagram = diagramSerializer.TryCreateInstance(serializationContext, reader, diagramPartition) as VisorDatosDSLDiagram;
										if (diagram != null)
										{
		...
		/// <summary>
		/// Helper method to create and initialize a new VisorDatosDSLDiagram.
		/// </summary>
		...
		internal protected virtual VisorDatosDSLDiagram CreateDiagramHelper(DslModeling::Partition diagramPartition, DslModeling::ModelElement modelRoot)
		{
			VisorDatosDSLDiagram diagram = new VisorDatosDSLDiagram(diagramPartition);
			return diagram;
		}
		...
		/// <param name="diagram">VisorDatosDSLDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, FuentesDeDatosModel modelRoot, string modelFileName, VisorDatosDSLDiagram diagram, string diagramFileName)
		{
		...
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, FuentesDeDatosModel modelRoot, string modelFileName, VisorDatosDSLDiagram diagram, string diagramFileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <summary>
		/// Saves the given FuentesDeDatosModel and VisorDatosDSLDiagram to the given files, with specified encoding.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="modelRoot">FuentesDeDatosModel instance to be saved.</param>
		/// <param name="modelFileName">Name of the file in which the CanonicalSampleRoot instance will be saved.</param>
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, FuentesDeDatosModel modelRoot, string modelFileName, VisorDatosDSLDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		/// <param name="diagram">VisorDatosDSLDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, VisorDatosDSLDiagram diagram, string diagramFileName)
		{
		...
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, VisorDatosDSLDiagram diagram, string diagramFileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <summary>
		/// Saves the given VisorDatosDSLDiagram to the given file, with specified encoding.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="diagram">VisorDatosDSLDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, VisorDatosDSLDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		public virtual void WriteRootElement(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement rootElement, global::System.Xml.XmlWriter writer)
		{
			...
			if (!(rootElement is DslDiagrams::Diagram))
			{
				...
				rootElementSettings.SchemaTargetNamespace = "http://schemas.microsoft.com/dsltools/VisorDatosDSL";
			}
		...
		protected virtual void CheckVersion(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader)
		{
			...
			if (dslVersionStr != null)
			{
				try
				{
					...
					{
						VisorDatosDSLSerializationBehaviorSerializationMessages.VersionMismatch(serializationContext, reader, expectedVersion, actualVersion);
					}
				}
				catch (global::System.ArgumentException)
				{
					VisorDatosDSLSerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "dslVersion", typeof(global::System.Version), dslVersionStr);
				}
		...
		protected virtual global::System.Xml.XmlReader TryCreateValidatingReader(DslModeling::ISchemaResolver schemaResolver, global::System.Xml.XmlReader reader, DslModeling::SerializationContext serializationContext)
		{
			...
			if (success && schemaSet.Count > 0)
			{
				...
				VisorDatosDSLSerializationBehaviorSchemaValidationCallback validationCallback = new VisorDatosDSLSerializationBehaviorSchemaValidationCallback(serializationContext);
		...
		protected static bool ResolveSchema(string targetNamespace, global::System.Xml.Schema.XmlSchemaSet schemaSet, DslModeling::ISchemaResolver schemaResolver, global::System.Xml.XmlReader reader, DslModeling::SerializationContext serializationContext)
		{
			...
			if (schemas != null && schemas.Count > 0)
			{
				if (schemas.Count > 1)
				{
					VisorDatosDSLSerializationBehaviorSerializationMessages.AmbiguousSchema(serializationContext, reader, targetNamespace, schemas[0]);
				}
				schemaSet.Add(targetNamespace, schemas[0]);
				return true;
			}
	
			VisorDatosDSLSerializationBehaviorSerializationMessages.NoSchema(serializationContext, reader, targetNamespace);
			return false;
		}
		...
		/// </summary>
		private sealed class VisorDatosDSLSerializationBehaviorSchemaValidationCallback
		{
			...
			internal VisorDatosDSLSerializationBehaviorSchemaValidationCallback(DslModeling::SerializationContext serializationContext)
			{
				global::System.Diagnostics.Debug.Assert(serializationContext != null);
			...
			internal void Handler(object sender, global::System.Xml.Schema.ValidationEventArgs e)
			{
				...
				if (this.serializationContext != null)
					VisorDatosDSLSerializationBehaviorSerializationMessages.SchemaValidationError(this.serializationContext, this.reader, e.Message);
			}
			#endregion
		}
		...
		public virtual string GetSerializedModelString(global::VisorDatosDSL.FuentesDeDatosModel modelRoot, global::System.Text.Encoding encoding)
		{
...
namespace VisorDatosDSL
{
	...
	public partial class FuentesDeDatosModel
	{
		/// <summary>
		...
		private void ValidateMonikerAmbiguity(DslValidation::ValidationContext context)
		{
			...
			global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> monikerResolvers = VisorDatosDSLSerializationHelper.Instance.GetMonikerResolvers(this.Store);
						...
						{	// Ambiguous moniker detected.
							context.LogError(
								string.Format(
									...
									VisorDatosDSLDomainModel.SingletonResourceManager.GetString("AmbiguousMoniker"),
									amEx.Moniker,
