...
namespace VisorDatosDSL
{
	...
	/// </remarks>
	public partial class VisorDatosDSLHelpKeywordHelper : VisorDatosDSLHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new VisorDatosDSLHelpKeywordHelper.
		/// </summary>
		protected VisorDatosDSLHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the VisorDatosDSLHelpKeywordHelper.
		/// </summary>
		public static VisorDatosDSLHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class VisorDatosDSLHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new VisorDatosDSLHelpKeywordHelperBase.
		/// </summary>
		protected VisorDatosDSLHelpKeywordHelperBase()
			: base() { }
